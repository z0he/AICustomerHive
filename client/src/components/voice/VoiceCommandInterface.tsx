      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between">
        ...
        <div className="mt-4 md:mt-0 flex items-center">
          <div className="bg-white shadow-sm border border-slate-200 rounded-xl flex items-center w-full md:w-auto">
            <Button 
              variant="ghost" 
              className={`p-3 rounded-l-xl ${isListening ? 'bg-slate-50' : ''}`} 
              onClick={onToggleListening}
            >
              <div className={`h-8 w-8 rounded-full ${isListening ? 'bg-red-500 animate-pulse' : 'bg-accent-500'} flex items-center justify-center`}>
