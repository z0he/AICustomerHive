...
const accentButtonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[#8AC33E] text-white hover:bg-[#7AB22D] shadow",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-sm",
        outline:
          "border border-[#8AC33E] text-[#8AC33E] bg-transparent hover:bg-[#8AC33E]/10 shadow-sm",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm",
        ghost:
          "text-[#8AC33E] hover:bg-[#8AC33E]/10",
        link:
          "text-[#8AC33E] underline-offset-4 hover:underline",
      },
      size: {
...
export { AccentButton, accentButtonVariants }